...
import { CommandParser } from '../presentation/cli/command-parser';
...
describe('CommandParser', () => {
  describe('parseCommand', () => {
    ...
    it('should handle parameters with quotes', () => {
      const result = CommandParser.parseCommand('add_transaction narration="午餐" description="日常支出"');
  ...
  describe('validateCommand', () => {
    it('should validate valid commands', () => {
      const validCommands = ['help', 'add_transaction', 'list_transactions', 'show_balance'];
    ...
    it('should reject invalid commands', () => {
      const invalidCommands = ['unknown_command', 'invalid', 'test123'];
  ...
  describe('getCommandHelp', () => {
    it('should return help for valid commands', () => {
      const validCommands = ['help', 'add_transaction', 'list_transactions'];
    ...
    it('should return null for invalid commands', () => {
      const invalidCommands = ['unknown_command', 'invalid'];
  ...
  describe('getCommandSuggestions', () => {
    it('should return suggestions for partial input', () => {
      const suggestions = CommandParser.getCommandSuggestions('add');
      expect(suggestions).toBeInstanceOf(Array);
      expect(suggestions.length).toBeGreaterThan(0);
      expect(suggestions).toContain('add_transaction');
    });

    it('should return empty array for no match', () => {
      const suggestions = CommandParser.getCommandSuggestions('xyz');
      expect(suggestions).toBeInstanceOf(Array);
    });
  });
