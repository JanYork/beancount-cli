...
describe('ListTransactionsCommand', () => {
  let instance: ListTransactionsCommand;
  ...
  beforeEach(() => {
    ...
    instance = new ListTransactionsCommand(mockEngine);
  });
  ...
  describe('constructor', () => {
    it('应该正确创建实例', () => {
      ...
      expect(instance).toBeInstanceOf(ListTransactionsCommand);
    });
  });
